...
<body class="bg-gray-100">
    ...
    <div class="container relative justify-center pt-16">
        <div class="flex flex-col items-center min-h-screen ">
                ...
                <form method="post" action="{{ route('comments.store', ['postid' => $post->id]) }}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" enctype="multiple/form-data">
                    ...
                    <div class="mb-4">
                      ...
                      <textarea name="commentcontent" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Type here to add a comment"></textarea>
                    </div>


                    <div class="flex items-center justify-between">
                      <input type="submit" value="Comments" onclick="submitComment()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">     
                    </div>
                </form>
                    </div>
        </div>
